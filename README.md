...
| <a name="output_network_endpoint_groups"></a> [network\_endpoint\_groups](#output\_network\_endpoint\_groups) | A map of Compute Engine region names to NEG identifiers. |
